...
export async function up(knex: Knex): Promise<void> {
  return await knex.schema
    ...
    .createTable('employees', (table) => {
      ...
      table.string('recipient_id').nullable().references('id').inTable('public.employees');
    })
    .createTable('orders', (table) => {
      ...
      table.string('customer_id').notNullable().references('id').inTable('public.customers')
        .onDelete('CASCADE');
      table.string('employee_id').notNullable().references('id').inTable('public.employees')
        .onDelete('CASCADE');
    })
    ...
    .createTable('products', (table) => {
      ...
      table.string('supplier_id').notNullable().references('id').inTable('public.suppliers')
        .onDelete('CASCADE');
    })
    .createTable('order_details', (table) => {
      ...
      table.string('order_id').primary().references('id').inTable('public.orders')
        .onDelete('CASCADE');
