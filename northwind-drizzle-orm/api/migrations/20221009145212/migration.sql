DO $$ BEGIN
 CREATE TYPE query_type AS ENUM('SELECT', 'SELECT_WHERE', 'SELECT_LEFT_JOIN', 'SELECT_LEFT_JOIN_WHERE');
EXCEPTION
...
DO $$ BEGIN
 ALTER TABLE employees ADD CONSTRAINT employees_reports_to_employees_id_fk FOREIGN KEY ("reports_to") REFERENCES employees("id");
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
